...
$more = elgg_echo('menu:howwork');
echo "<a href=\"#\">$more</a>";

echo '<ul class="elgg-menu elgg-menu-site elgg-menu-site-more">';

$link = elgg_echo('menu:howwork:welcome');
echo "<li class='elgg-menu-item'><a href='https://plataforma.somenergia.coop/groups/profile/1117/bienvenida'>$link</a></li>";
