...
function somenergia_customization_init() {
    ...
    /* Drive link in Preceso Participativo */
    ...
    // Add Intro message in Som Energia theme
    elgg_register_plugin_hook_handler('somenergia:index:pre', 'view', 'somenergia_customization_extend_index');
}

function somenergia_customization_extend_index($hook, $type, $value, $params) {
    if ($hook == 'somenergia:index:pre') {
        return elgg_view('somenergia-customization/intro');
    }
}
